    ...
    <body>
        ...
        <form method="POST" action="" style="Width:50%;margin-top:10%;"  >
                ...
                <table style="Width:100%" >
                    <tr>
                        <td>
                            <h2 style="margin-left: 43%;">Rejection</h2>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="Label" value= "Give Reasons For Rejection" style="outline:none; border:none; background:transparent;width:100%">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <input type="submit" name="sub" value="Reject" style="padding: 10px 20px; background-color: #000033; color: white; border: none; border-radius: 6px; cursor: pointer; margin-top: 10px; width: 50%; margin-left: 24%;">
                        </td>
                    </tr>
                </table>
        </form>
        ...
        <?php
        	if (isset($_POST['sub'])&& $_POST['sub'] !== "") {
        	    $not= $_POST['notes'];
				$die= $_GET['id3'];
				$sq2= " UPDATE flag_data set status = 'REJECTED', validationNotes = '$not' WHERE id like '$die' ";
