        ...
        <form id="surveyForm" enctype="multipart/form-data" >
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="importerContact" name="importerContact" placeholder="Enter importer contact" required>
                </div>
            </div>
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="agentContact" name="agentContact" placeholder="Enter agent contact" required>
                </div>
            </div>
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="vehicleImages" name="vehicleImages" accept=".jpg,.jpeg,.png,.pdf,.mp4,.avi" required>
                </div>
                <div class="form-group">
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="supportingDocs" name="supportingDocs" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple required>
                </div>
                <div class="form-group">
