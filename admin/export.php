...
<?php 
  ...
  {  
  	  $content .='<tr>';
	    $content .="<td style='border:1px solid gray;'><center> ". $row['id']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['issuingBody']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['certificateType']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['cargoOrigin']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['shipmentRoute']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['certificateNo']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['customsDeclNo']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['importerName']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['importerContact']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['exporterName']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['agentName']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['agentContact']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['transportMode']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['transporterName']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['vehicleNumber']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['dischargeLocation']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['finalDestination']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['fobCurrency']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['fobValue']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['incoterm']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['freightCurrency']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['freightValue']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['validationNotes']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['status']."</center></td>";
	    $content .="<td style='border:1px solid gray;'><center> ". $row['date']."</center></td>";
	   $content .='<tr>';   
  } 
  $content.='</table>'; 
